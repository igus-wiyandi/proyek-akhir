...
class perhitungan_gajiController extends Controller
{
    ...
    public function filterByDateRange(Request $request)
    {
        ...
        $guru = guru::with(['latestAbsensi.jabatan.kategori'])->get();
if(!$isAdmin){
            $guru = guru::with(['latestAbsensi.jabatan.kategori'])
        ...
        foreach ($guru as $item) {
            ...
            $gajiTotal = $gajiMengajar + $honorWaliKelas;

            $latestAbsensi = $item->latestAbsensi;
            $jabatan = $latestAbsensi->jabatan ?? null;
