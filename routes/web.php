...
Route::middleware(LoggedInGuru::class)->group(function () {
    ...
    Route::get('/tampilGuru/{tampilGuru}/edit', [TampilGuruController::class, 'edit'])->name('tampilGuru.edit');
    Route::put('/tampilGuru/{tampilGuru}', [TampilGuruController::class, 'update'])->name('tampilGuru.update');
});
