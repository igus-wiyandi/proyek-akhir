...
<div class="w-full p-6 bg-gray-100 min-h-screen">
    <div class="w-full bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <form method="POST" action="{{ route('mapel11.update', $mapel11->id) }}" class="p-6">
            @method('PUT')
            @csrf
            ...
            <div class="mb-4">
                ...
                <input type="date" name="tanggal" id="tanggal"
                    ...
                    value="{{ old('tanggal', isset($mapel11->tanggal) ? \Carbon\Carbon::parse($mapel11->tanggal)->format('Y-m-d') : '') }}">
            ...
            <div class="mb-4">
                ...
                <input type="time" name="jam_mulai" id="jam_mulai"
                    ...
                    value="{{ old('jam_mulai', isset($mapel11->jam_mulai) ? \Carbon\Carbon::createFromFormat('H:i:s', $mapel11->jam_mulai)->format('H:i') : '') }}">
            ...
            <div class="mb-4">
                ...
                <input type="time" name="jam_selesai" id="jam_selesai"
                    ...
                    value="{{ old('jam_selesai', isset($mapel11->jam_selesai) ? \Carbon\Carbon::createFromFormat('H:i:s', $mapel11->jam_selesai)->format('H:i') : '') }}">
