...
<div class="w-full p-6 bg-gray-100">
    <div class="w-full bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="bg-teal-600 p-4 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-white">Data Guru</h2>
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-teal-50">
                        ...
                        <th class="p-3 text-left text-teal-800 font-semibold border-b border-teal-200">NIK</th>
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="p-3 border border-gray-200">{{ $gurus->nama }}</td>
                        <td class="p-3 border border-gray-200">{{ $gurus->nik }}</td>
                        <td class="p-3 border border-gray-200">{{ $gurus->user->email ?? '-' }}</td>
                        <td class="p-3 border border-gray-200">{{ $gurus->no_hp }}</td>
                        <td class="p-3 border border-gray-200">{{ $gurus->alamat }}</td>
                        <td class="p-3 border border-gray-200">
                            <div class="flex space-x-3">
                                <a href="{{ route('guru.edit', $gurus->id) }}" class="text-teal-600 hover:text-teal-800" title="Edit">
